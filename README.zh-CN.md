...
源代码以 [GPL-3.0-or-later](./LICENSE) 开源：任何人都可以自由使用、修改和再分发，但修改后的衍生作品必须以相同条款公开源代码。

官方发布的安装包免费供用户使用。GPL 不允许将本软件集成到闭源商业产品中；如需闭源商用（含收益分成安排），请通过 [GitHub Issues](https://github.com/ChqJourney/smart_reader/issues) 联系洽谈单独的商业授权。
